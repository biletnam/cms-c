...
class NewsConfig extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('view_count, widget_count', 'numerical', 'integerOnly' => true, 'message' => 'Значение должно быть числом'),
            array('title', 'length', 'max' => 255),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, title, view_count, widget_count', 'safe', 'on' => 'search'),
            array('title, view_count, widget_count', 'safe'),
    ...
    public function attributeLabels()
    {
        return array(
            'id' => 'ID',
            'title' => 'Заголовок списка новостей',
            'view_count' => 'Количество новостей на странице (0 - пагинация отключена)',
            'widget_count' => 'Количество «свежих новостей» в виджете',
        );
    }
